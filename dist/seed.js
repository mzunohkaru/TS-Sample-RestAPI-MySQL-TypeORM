    ...
    try {
        ...
        const posts = [
            ...
            },
            {
                ...
                content: "Docker provides a way to run applications in lightweight containers...",
                userId: savedUsers[3].id,
            },
            {
                title: "Web Security Fundamentals",
                content: "Security should be a primary concern when building web applications...",
                userId: savedUsers[3].id,
            },
            {
